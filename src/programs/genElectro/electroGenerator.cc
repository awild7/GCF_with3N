...
bool electroGenerator::parse_phase_space_file(char* phase_space)
{
...
void electroGenerator::set_nu_range(double low, double high)
{
  numin = low;
  numax = high;
}

void electroGenerator::set_QSq_range(double low, double high)
{
  QSqmin = low;
  QSqmax = high;
}

void electroGenerator::set_phik_range(double low, double high)
{
  phikmin = low;
  phikmax = high;
}

void electroGenerator::set_phik_range_deg(double low, double high)
{
