...
void gcfNucleus::set_Interaction(char* thisPType){
...
void gcfNucleus::set_Cpp0(double newCpp0){

  Cpp0 = newCpp0;
  
}

void gcfNucleus::set_Cnn0(double newCnn0){

  Cnn0 = newCnn0;
  
}

void gcfNucleus::set_Cpn0(double newCpn0){

  Cpn0 = newCpn0;
  
}

void gcfNucleus::set_Cpn1(double newCpn1){
...
NNModel gcfNucleus::get_InteractionType(){

  return u;
  
}

double gcfNucleus::get_Cpp0(){

  return Cpp0;
  
}

double gcfNucleus::get_Cnn0(){

  return Cnn0;
  
}

double gcfNucleus::get_Cpn0(){

  return Cpn0;
  
}

double gcfNucleus::get_Cpn1(){
...
bool gcfNucleus::set_Contacts_SS_r()
{
  if ((Z==1) && (N==1))
    {
      if (u==AV18)
...
bool gcfNucleus::set_Contacts_SS_k()
{
  if ((Z==1) && (N==1))
    {
      if (u==AV18)
...
bool gcfNucleus::set_Contacts_EG2()
{
  if ((Z==6) && (N==6))
    {
      if (u==AV18)
...
void gcfNucleus::fill_arrays_n2lo_local()
{
  for (int i=0 ; i<100; i++)
    {
...
void gcfNucleus::fill_arrays_n3lo_nonlocal()
{
  for (int i=0 ; i<100; i++)
    {
...
void gcfNucleus::fill_arrays_n2lo_12_local()
{
  for (int i=0 ; i<100; i++)
    {
